            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <form method="post" id="passwordForm">
                        ...
                        <input type="password" class="form-control" name="password1" id="password1" placeholder="Nueva Clave" autocomplete="off" >
                        <div class="row">
                            <div class="col-sm-6">
                                <span id="8char" class="verificacionErrada fas fa-times" style="color:#FF0004;"></span> 6 caracteres largos<br>
                                <span id="ucase" class="verificacionErrada fas fa-times" style="color:#FF0004;"></span> Una letra mayúscula
                            </div>
                            <div class="col-sm-6">
                                <span id="lcase" class="verificacionErrada fas fa-times" style="color:#FF0004;"></span> Una letra minúscula
                                <br>
                                <span id="num" class="verificacionErrada fas fa-times" style="color:#FF0004;"></span> Un número
                            </div>
                        </div>
                        <input type="password" class="input-lg form-control" name="password2" id="password2" placeholder="Repetir Clave" autocomplete="off">
                        <div class="row">
                            <div class="col-sm-12">
                                <span id="pwmatch" class="verificacionErrada fas fa-times" style="color:#FF0004;"></span>Las contraseñas coinciden
                            </div>
                        </div>
                        <br>
                        <input id="CambioClave" class="col-xs-12 btn btn-primary" data-loading-text="Changing Password..." value="Cambio de contraseña">
                    </form>
                </div>
                <div class="col-md-3">
