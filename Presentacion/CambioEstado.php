                    ...
                    <div class="container">
                        ...
                        <form class="form-inline" onsubmit="return false">
                            <div class="form-group ">
                                ...
                                &nbsp
                                <input type="search" class="input-sm form-control " placeholder="Búsqueda" id = "txtBusquedaCodigo">
                                &nbsp <button type="submit" id ="BtnFiltro" class="btn btn-primary btn-sm" onclick="entrada()"><span class="glyphicon glyphicon-eye-open"></span> Buscar</button>
                            </div>
                        </form>
                        <form method="post">
...
<script>
    ...
    function tabla(tmp) {
        ...
        } else if (tmp.actividad === "Entregado") {
            estr.append("<td><button value=" + tmp.idPrestamo + " type='sumit' id='btnHistorial' class='btn btn-success' onclick= 'Entrega(" + tmp.idPrestamo + ")'>Entregados</button></td>");
        } else {
