 ...
 * */
/**
 * Capa de presentación de registrar los videos beam y registrar 
 * los computadores donde se puede hacer la busqueda , insertar , actuliazar
 * y eliminar datos.
 * 
 * @category Educativo
            ...
            <div class="row">
                <div class="col-md-9">
                    <form id="registar_VideoBeam" name ="registar_VideoBeam" method="POST" enctype=" multipart/form-data">
                        ...
                        <br>
                        <button class="btn btn-primary" type = "submit" id="btnRegistrarVideoBeam">Registrar</button>
                        <button class="btn btn-primary" id="btnLimpiarVideoBeam" type="reset">Limpiar</button>
                        ...
                        <button class="btn btn-primary" type = "submit" id="btnBuscarVideoBeam">Buscar</button>
                    </form>
                    <br>
                    <form id="registar_Computador" name ="registar_Computador" method="POST" enctype=" multipart/form-data">
                        ...
                        <button class="btn btn-primary" id="btnLimpiarComputador" type="reset">Limpiar</button>
