...
class ComputadorDAO {
    ...
    /**
     * Este metodo permite modificar informacíon sobre computador como
     * es el fabricante y el número del cargador que corresponde al computador, además 
     * de contar con sus observsaciones.
     * @author Esteban fabian patiño montealegre <estebanfabianp@gmail.com> 
     * @since Revision: 1.0 
     * @param array() $array datos de tipo json que contiene la informacion a registrar del computador 
    ...
    /**
     * Este metodo valida si el computador ya esta registrado en la base de datos
     * @author Esteban fabian patiño montealegre <estebanfabianp@gmail.com> 
     * @since Revision: 1.0 
    ...
    /**
     * Este metodo carga todos los numero de identificacion de los computadores
     * @author Esteban fabian patiño montealegre <estebanfabianp@gmail.com> 
     * @since Revision: 1.0 
     * @param array() $array datos de tipo json que contiene el numero de serial del video beam que desea validar su existencia en la base de datos.
     * @return array() el numero de identificacion del computador.
     * */
    function CargarComputadores($array) {
